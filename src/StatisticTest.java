...
public class StatisticTest {
	...
	@Test
	public void getMeanWithOutNumber(){
		Statistic statistic = new Statistic();
		float mean = statistic.getMean();
		assertEquals("Is not the media expected. ", 0, mean, 0.1);
	}
	
	@Test
	public void getMeanWithOneNumber(){
		Statistic statistic = new Statistic();
		LinkedList<Float> number = new LinkedList<Float>();
		number.add((float) 6);
		float mean = statistic.getMean(number);
		assertEquals("Is not the media expected. ", 6, mean, 0.1);
	}
